...
faze_player_stats = {player_name: list(faze_player_stat_value[i]) for i, player_name in enumerate(faze_player_stats.keys())}
navi_player_stats = {player_name: list(navi_player_stat_value[i]) for i, player_name in enumerate(navi_player_stats.keys())}
