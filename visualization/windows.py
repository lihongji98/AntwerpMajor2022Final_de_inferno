...
from function import check_condition
...
def create_function_button(frame, text, x, y):
    button = tk.Button(frame, text=text, font=Config.button_font, width=Config.button_width, height=Config.button_height)
...
if __name__ == '__main__':
    ...
    create_function_button(window, "Player Stats", x=300, y=Config.function_button_y)
    create_function_button(window, "Player Heatmap", x=450, y=Config.function_button_y)
    create_function_button(window, "Frags", x=600, y=Config.function_button_y)
    create_function_button(window, "Weapon Stats", x=750, y=Config.function_button_y)
    create_function_button(window, "others", x=900, y=Config.function_button_y)
